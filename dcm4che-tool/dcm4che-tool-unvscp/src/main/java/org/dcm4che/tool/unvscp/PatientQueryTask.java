...
class PatientQueryTask extends BasicQueryTask {
    ...
    protected final IDicomReader ddr;
    ...
    public PatientQueryTask(Association as, PresentationContext pc, Attributes rq, Attributes keys,
            IDicomReader ddr, String availability) throws DicomServiceException {
        super(as, pc, rq, keys);
        this.ddr = ddr;
    ...
    protected Attributes adjust(Attributes match) {
        ...
        if (keys.contains(Tag.SOPClassUID) && match.getString(Tag.ReferencedSOPClassUIDInFile) != null)
             adjust.setString(Tag.SOPClassUID, VR.UI,
                     match.getString(Tag.ReferencedSOPClassUIDInFile));
        if (keys.contains(Tag.SOPInstanceUID) && match.getString(Tag.ReferencedSOPInstanceUIDInFile) != null)
