...
set MAIN_CLASS=org.dcm4che3.tool.unvscp.UnvSCP
set MAIN_JAR=dcm4che-tool-unvscp-3.3.0.jar
...
set CP=%DCM4CHE_HOME%\etc\unvscp\
...
set CP=%CP%;%DCM4CHE_HOME%\lib\httpmime-4.3.2.jar
